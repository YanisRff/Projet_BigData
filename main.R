...
histo_VesselType_mean <- function(med){
  ...
  print(Width_y)
  vt_w <- ggplot(mapping =aes(x = reorder(c("Passager", "Cargo", "Tanker"),Width_y), y = Width_y)) + 
    geom_bar(stat="identity", fill="steelblue")+
  ...
  print(Draft_y)
  vt_d <- ggplot(mapping =aes(x = reorder(c("Passager", "Cargo", "Tanker"),Draft_y), y = Draft_y)) + 
    geom_bar(stat="identity", fill="steelblue")+
  ...
  print(Length_y)
  vt_l <- ggplot(mapping =aes(x = reorder(c("Passager", "Cargo", "Tanker"),Length_y), y = Length_y)) + 
    geom_bar(stat="identity", fill="steelblue")+
